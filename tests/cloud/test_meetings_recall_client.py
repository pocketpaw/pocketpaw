...
def test_segments_to_vtt_skips_empty_turns():
    ...
    from ee.cloud.meetings.recall_client import _segments_to_vtt
...
async def test_webhook_transcript_done_triggers_ingest(monkeypatch):
    ...
    from ee.cloud.meetings import webhooks
    ...
    monkeypatch.setattr("ee.cloud.meetings.service.ingest_transcript_for_recall_bot", _fake_ingest)
...
async def test_webhook_ignores_unrelated_events(monkeypatch):
    ...
    monkeypatch.setattr(
        "ee.cloud.meetings.service.ingest_transcript_for_recall_bot", _must_not_call
    )
