# Tests for src/pocketpaw/agents/sdk_mcp_meetings.py — in-process MCP
...
from pocketpaw.agents.sdk_mcp_meetings import (
    MEETING_TOOL_IDS,
    SEND_BOT_TOOL_ID,
    SERVER_NAME,
...
async def test_handler_errors_when_no_identity(monkeypatch):
    ...
    monkeypatch.setattr("ee.cloud.chat.agent_service.current_workspace_id", lambda: None)
    monkeypatch.setattr("ee.cloud.chat.agent_service.current_user_id", lambda: None)
