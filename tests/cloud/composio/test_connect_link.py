...
from ee.cloud.composio import connect_link
from ee.cloud.composio.connect_link import (
    as_inline_ripple,
    detect_connect_link,
...
def test_emit_skipped_when_feature_flag_disabled() -> None:
    ...
    with patch("ee.cloud.chat.agent_service.push_sse_event") as push:
...
# ``ee/cloud/composio/mcp.py``). Connect Link responses arrive at the
