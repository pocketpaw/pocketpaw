...
async def _handle_pairing_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info("✅ Paired with user: %s (%s)", username, user_id)
        ...
        <form id="setup-form" method="POST" action="/setup">
            <div class="step">
                ...
                <p style="color: #888; font-size: 14px; margin-top: 8px;">
                    Open <a href="https://t.me/BotFather" target="_blank"
                    style="color: #667eea;">@BotFather</a> on Telegram and send
                    <code>/newbot</code>
                </p>
            ...
            <div class="step api-keys">
                ...
                <p style="color: #888; font-size: 14px; margin-top: 8px;">
                    Add API keys for cloud LLMs. Leave blank to use local
                    Ollama only.
                </p>
