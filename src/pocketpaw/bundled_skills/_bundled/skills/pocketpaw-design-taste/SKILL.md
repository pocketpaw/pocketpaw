...
- **Ban Inter for premium/creative briefs.** It's the single loudest AI tell. Reach for a distinctive grotesk - Satoshi, General Sans, Clash Display, Cabinet Grotesk, PP Neue Montreal. Geist, Space Grotesk, Roboto and Plus Jakarta Sans have joined Inter on the overused list; they are not the way out of it. Inter is only OK when the read is explicitly neutral/standard/Linear-style, or trust-first.
