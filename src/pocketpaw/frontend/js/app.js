    ...
    return {
        ...
        handleSettings(data) {
            ...
            const SETTINGS_MAP = [
                ...
                'budgetMonthlyUsd', 'budgetWarningThreshold', 'budgetAutoPause',
                'budgetResetDay', 'traceRetentionDays',
        ...
        _SETTINGS_INDEX: [
            ...
            { section: 'system', sectionLabel: 'System', label: 'Monthly Budget Cap', hint: 'budget cost spending usd cap' },
            { section: 'system', sectionLabel: 'System', label: 'Budget Warning Threshold', hint: 'budget warning threshold percent' },
            { section: 'system', sectionLabel: 'System', label: 'Auto-Pause on Budget Limit', hint: 'budget pause safety' },
            { section: 'system', sectionLabel: 'System', label: 'Budget Reset Day', hint: 'monthly reset day' },
            { section: 'system', sectionLabel: 'System', label: 'Trace Retention', hint: 'traces retention cleanup days' },
