...
class PocketPawSocket {
    ...
    saveSettings(settings) {
        this.send('settings', {
            ...
            openai_agents_max_turns: parseInt(settings.openaiAgentsMaxTurns) || 25,
            google_adk_model: settings.googleAdkModel || 'gemini-2.5-flash',
            google_adk_max_turns: parseInt(settings.googleAdkMaxTurns) || 25,
            codex_cli_model: settings.codexCliModel || 'o4-mini',
            codex_cli_max_turns: parseInt(settings.codexCliMaxTurns) || 25,
            opencode_base_url: settings.opencodeBaseUrl || 'http://localhost:4096',
            opencode_model: settings.opencodeModel || '',
            opencode_max_turns: parseInt(settings.opencodeMaxTurns) || 25,
