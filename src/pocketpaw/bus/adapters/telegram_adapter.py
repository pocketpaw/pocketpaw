...
class TelegramAdapter(BaseChannelAdapter):
    ...
    async def send(self, message: OutboundMessage) -> None:
        ...
        try:
            ...
            # `AgentLoop` sends "is_stream_chunk=True" for deltas, and
            # "is_stream_end=True" (empty) at end.
            # BUT, it DOESN'T validly send the "Full" message as a separate event in
            ...
            if message.is_stream_chunk:
                ...
                # Let's Implement a crude accumulator or just rely on `AgentLoop`
                ...
                # Actually, `AgentLoop` code is "Unified". Dashboard LOVES streaming.
                # Telegram HATES it.
