...
class TelegramAdapter(BaseChannelAdapter):
    ...
    async def send(self, message: OutboundMessage) -> None:
        ...
        try:
            ...
            # BUT, it DOESN'T validly send the "Full" message as a separate event
            # in current loop implementation.
            # Loop implementation:
            #   - Yields chunks.
            ...
            if message.is_stream_chunk:
                ...
                # Let's implement a crude accumulator or rely on
                ...
                # Actually, `AgentLoop` is "Unified". Dashboard LOVES streaming.
                # Telegram HATES it.
