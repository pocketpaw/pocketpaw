...
async def build_preamble(workspace_id: str, user_id: str, meta: SurfaceMeta) -> SurfacePreamble:
    ...
    text = (
        ...
        "list, a table, a comparison, or a captured page worth showing. Use "
        "only widget types that already exist (table, cards, image, timeline, "
        "text). Do NOT invent action verbs for widget buttons — a button wired "
