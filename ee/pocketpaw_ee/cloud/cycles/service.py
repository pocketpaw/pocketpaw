...
from pocketpaw_ee.cloud.cycles.domain import Cycle, CycleDailyPoint
...
from pocketpaw_ee.cloud.models.cycle import Cycle as _CycleDoc
from pocketpaw_ee.cloud.models.cycle import CycleDailyPoint as _CycleDailyPointDoc
...
async def agent_create_cycle(ctx: RequestContext, body: CreateCycleRequest) -> CycleResponse:
    ...
    if (
        ...
        and await _has_active_overlap(workspace_id, body.pocket_id, body.start, body.end)
    ):
        raise ConflictError(
            "cycle.overlap",
