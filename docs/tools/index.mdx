...
<CardGroup>
  ...
  <Card title="Flow Authoring" icon="lucide:list-ordered" href="/tools/flow-authoring">
    Scaffold a complete multi-step flow (wizard, intake, survey) from a descriptor.
  </Card>
...
| `start_flow` | `group:ripple` | Scaffold a multi-step Chain Flow from a descriptor |
